...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/SortingCompetition.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/SortingCompetition.o: SortingCompetition.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SortingCompetition.o SortingCompetition.cpp
